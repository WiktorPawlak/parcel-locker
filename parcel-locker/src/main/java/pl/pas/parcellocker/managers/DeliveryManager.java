...
public class DeliveryManager {
    ...
    public void putInLocker(Delivery delivery, String accessCode) {
        Locker locker = lockers.findByIdentityNumber(delivery.getLocker());
        Client receiver = clients.findById(delivery.getReceiver());

        locker.putIn(delivery, receiver.getTelNumber(), accessCode);
