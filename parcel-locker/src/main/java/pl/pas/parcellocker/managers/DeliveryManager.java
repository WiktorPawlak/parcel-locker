...
public class DeliveryManager {
  ...
  @Inject private LockerRepository lockerRepository;
  ...
  public void putInLocker(UUID deliveryId, String lockerId, String accessCode) {
  ...
  public void takeOutDelivery(UUID deliveryId, String receiverTel, String accessCode) {
    Delivery latestDeliveryState = deliveryRepository.get(deliveryId);
